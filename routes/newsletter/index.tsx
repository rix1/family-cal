...
export default define.page<typeof handlers>(({ data }) => {
  ...
  return (
    <>
      <title>Subscribe | Family Calendar</title>
      <div class="min-h-screen">
        ...
        <main class="mx-auto max-w-2xl px-4 pb-20 pt-8">
          <h1 class="text-2xl font-semibold tracking-tight">Subscribe</h1>
          <p class="mt-2 leading-relaxed text-ink-2">
            Two ways to keep up with the family's dates: a short note by email each month, or a live
            feed you add to your own calendar app.
          </p>
          ...
          <form method="post" class="card mt-8 grid gap-6 p-6">
            <div>
              ...
              <p class="mt-1 text-sm leading-relaxed text-ink-2">
                Next month's family birthdays, once a month, written in Norwegian and sent by a
                family admin. No spam, and you can unsubscribe any time.
              </p>
            </div>
          ...
          <section class="card mt-8 grid gap-5 p-6">
            <div>
              ...
              <p class="mt-1 text-sm leading-relaxed text-ink-2">
                ...
                Calendar, or Outlook. The feed stays up to date on its own — subscribe once and new
                people appear automatically.
              </p>
            </div>
